...
class WatchListDialog(Gtk.Dialog):
    ...
    def __init__(self, library):
        ...
        """
        super(WatchListDialog, self).__init__(("Library watch list"),
            library, Gtk.DialogFlags.DESTROY_WITH_PARENT | Gtk.DialogFlags.MODAL,
            (('_Scan now').encode('utf-8'), WatchListDialog.RESPONSE_SCANNOW,
        ...
        self._remove_button = remove_button = Gtk.Button(("_Remove"), Gtk.STOCK_REMOVE)
        ...
        auto_checkbox = Gtk.CheckButton(
            ('Automatically scan for new books when library is _opened'), True)
