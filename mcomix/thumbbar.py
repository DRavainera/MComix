...
class ThumbnailSidebar(Gtk.ScrolledWindow):
    ...
    def set_thumbnail_background(self, colour):
        ...
        color = Gdk.RGBA(colour[0], colour[1], colour[2])
        self._pixbuf_cellrenderer.set_properties('cell-background-gdk',
                color)
        self._text_cellrenderer.set_properties('background-gdk',
                color)
        self._text_cellrenderer.set_properties('foreground-gdk',
