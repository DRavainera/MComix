...
class MainWindow(Gtk.Window):
    ...
    def is_fullscreen(self):
        window_state = self.was_fullscreen
    ...
    def delete(self, *args):
        ...
        dialog.set_text(
                ('Delete "%s"?') % os.path.basename(current_file),
                ('The file will be deleted from your harddisk.'))
        dialog.add_button(Gtk.STOCK_CANCEL, Gtk.ResponseType.CANCEL)
        dialog.add_button(Gtk.STOCK_DELETE, Gtk.ResponseType_OK)
        dialog.set_default_response(Gtk.ResponseType_OK)
        result = dialog.run()
