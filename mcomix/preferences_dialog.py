...
class _PreferencesDialog(Gtk.Dialog):
    ...
    def __init__(self, window):
        super(_PreferencesDialog, self).__init__(('Preferences'), window)
        ...
        notebook.append_page(appearance, Gtk.Label(('Appearance')))
        behaviour = self._init_behaviour_tab()
        notebook.append_page(behaviour, Gtk.Label(('Behaviour')))
        display = self._init_display_tab()
        notebook.append_page(display, Gtk.Label(('Display')))
        advanced = self._init_advanced_tab()
        notebook.append_page(advanced, Gtk.Label(('Advanced')))
        shortcuts = self.shortcuts = self._init_shortcuts_tab()
        notebook.append_page(shortcuts, Gtk.Label(('Shortcuts')))
    ...
    def _init_appearance_tab(self):
        ...
        page.add_row(Gtk.Label(('Language (needs restart):')),
            self._create_language_control())

        page.add_row(self._create_pref_check_button(
            ('Escape key closes program'), 'escape quits',
        ...
        thumb_fixed_bg_button, thumb_dynamic_bg_button = self._create_binary_pref_radio_buttons(
            ...
            'color box thumb bg',
            ('Always use this selected colour as the thumbnail background colour.'),
            'Use dynamic background colour',
            'smart thumb bg',
            ('Automatically use the colour that fits the viewed image for the thumbnail background.'))
        ...
        page.add_row(Gtk.Label(('Thumbnail size (in pixels):')),
        ...
        page.add_row(self._create_pref_check_button(
            ('Use checkered background for transparent images'),
    ...
    def _init_behaviour_tab(self):
        ...
        page.add_row(Gtk.Label(('Number of pixels to scroll per arrow key press:')),
        ...
        page.add_row(Gtk.Label(('Number of pixels to scroll per mouse wheel turn:')),
        ...
        page.add_row(Gtk.Label(('Fraction of page to scroll '
        ...
        page.add_row(Gtk.Label(('Number of "steps" to take before flipping the page:')),
        ...
        page.add_row(Gtk.Label(('Show only one page where appropriate:')),
            self._create_doublepage_as_one_control())

        page.add_row(Gtk.Label(('Page auto-resizing:')),
            self._create_double_page_autoresize_control())

        page.new_section(('Files'))

        page.add_row(self._create_pref_check_button(
            ('Automatically open the last viewed file on startup'),
            'auto load last file',
            ('Automatically open, on startup, the file that was open when MComix was last closed.')))

        page.add_row(Gtk.Label(('Store information about recently opened files:')),
    ...
    def _init_display_tab(self):
        ...
        page.add_row(Gtk.Label(('Scaling mode')),
    ...
    def _init_advanced_tab(self):
        ...
        page.add_row(Gtk.Label(('Sort files and directories by:')),
            self._create_sort_by_control())

        page.add_row(Gtk.Label(('Sort archives by:')),
            self._create_archive_sort_by_control())

        page.new_section(('Extraction and cache'))

        page.add_row(Gtk.Label(('Maximum number of concurrent extraction threads:')),
        ...
        page.add_row(Gtk.Label(('Maximum number of pages to store in the cache:')),
        ...
        page.add_row(Gtk.Label(('Comment extensions:')),
            self._create_extensions_entry())

        page.new_section(('Animated images'))

        page.add_row(Gtk.Label(('Animation mode:')),
    ...
    def _create_double_page_autoresize_control(self):
        ...
        items = (
                (('Prefer same scale'), constants.DOUBLE_PAGE_AUTORESIZE_SCALE),
                (('Fit to same size'), constants.DOUBLE_PAGE_AUTORESIZE_SIZE))
        ...
        box.set_tooltip_text(
            ("Maintain relative size or fit to same size."))
    ...
    def _store_recent_changed_cb(self, combobox, *args):
        ...
        if (bool(last_value) is True and value is False
            ...
            dialog.set_text(
                ('Delete information about recently opened files?'),
    ...
    def _create_animation_mode_combobox(self):
        ...
        box.set_tooltip_text(
            ('Controls how animated images should be displayed.'))
    ...
    def _create_color_button(self, prefkey):
        button = Gtk.ColorButton(Gdk.Color(*prefs[prefkey]))
