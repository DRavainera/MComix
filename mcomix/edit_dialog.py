...
class _EditArchiveDialog(Gtk.Dialog):
    ...
    def __init__(self, window):
        super(_EditArchiveDialog, self).__init__(('Edit archive'), window, Gtk.DialogFlags.MODAL,
        ...
        notebook.append_page(self._image_area, Gtk.Label(('Images')))
        notebook.append_page(self._comment_area, Gtk.Label(('Comment files')))
    ...
    def _load_original_files(self):
        ...
        self._window.set_cursor(Gdk.Cursor(Gdk.CursorType.WATCH))
    ...
    def _pack_archive(self, archive_path):
        ...
        if fail:
            ...
            dialog.set_text(
                ("The new archive could not be saved!"),
                ("The original files have not been removed."))
            dialog.run()
